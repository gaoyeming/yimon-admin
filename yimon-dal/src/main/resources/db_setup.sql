...
(
    ...
    `operator_type`       varchar(16)   NOT NULL COMMENT '操作类别，可以标记不同系统操作（yimon_admin）',
    ...
    KEY `sys_user_operation_log_idx_02` (`opera_title`),
    KEY `sys_user_operation_log_dataChange_lastTime` (`dataChange_lastTime`)
) ENGINE = InnoDB
