...
import com.yimon.admin.service.impl.DELETE_Repository;
import com.yimon.admin.service.impl.POST_Repository;
import com.yimon.admin.service.impl.PUT_Repository;
...
public class RepositoryServiceTest {
    ...
    public void insertTest() throws SQLException {
        ...
        insertMap.put("id", 1);
        insertMap.put("opera_user", "service-user");
        insertMap.put("opera_title", "service-title");
    ...
    public void postTest() throws SQLException {
        ...
        postMap.put("id", 1);
        postMap.put("opera_user", "service-user1");
        postMap.put("opera_title", "service-title1");
